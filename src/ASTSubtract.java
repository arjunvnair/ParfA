...
public class ASTSubtract extends SimpleNode 
{
	...
	public void interpret()
	{
	    ...
	    {
	    	C.io.println("Runtime error at line: " + jjtGetLastToken().endLine + ", column: " + jjtGetLastToken().endColumn + ", cannot subtract " + getName(ParfANode.stack[ParfANode.p + 1].getClass()) + " from " + getName(ParfANode.stack[ParfANode.p].getClass()) + ".");
